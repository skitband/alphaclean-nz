        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-md-6 col-sm-12">
                    <h3 class="text-heading">Don’t wait, Get a cleaning now!</h3>
                    <span class="sub-heading">Book expert cleaners and handymen at a moment's notice. Drop us a call or message and we’ll do the rest.</span>
