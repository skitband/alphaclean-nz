            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h6>RATED A+ IN CLEANING SERVICES</h6>
                    </div>
                </div>
                <div class="row mt-5">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="preference-about_home justify-content-center">
                                            ...
                                            <p>
                                                An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: <a href="https://automattic.com/privacy/" target="_blank" class="text-info">https://automattic.com/privacy/</a>. After approval of your comment, your profile picture is visible to the public in the context of your comment.
                                            </p>
                                            <h4>Media</h4>
